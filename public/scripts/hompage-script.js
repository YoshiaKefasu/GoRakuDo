...
function setupScrollAnimations() {
    ...
    const animatedElements = document.querySelectorAll('.mission-section, .features-section, .docs-preview-section');
...
function setupButtonEffects() {
    const buttons = document.querySelectorAll('.primary-button, .secondary-button, .cta-button, .docs-button');
