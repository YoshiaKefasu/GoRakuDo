...
export interface MetaTagGenerator {
  generateBasicTags(props: import('./component-props').BasicSEOProps): MetaTag[];
  generateSocialMediaTags(props: import('./component-props').BasicSEOProps): MetaTag[];
  generatePerformanceTags(props: import('./component-props').MetaManagerProps): PerformanceHint[];
  generateSecurityTags(props: import('./component-props').MetaManagerProps): SecurityHeader[];
  generateStructuredData(props: import('./component-props').BasicSEOProps): StructuredData[];
  validateGeneratedTags(tags: MetaTag[]): import('./validation').ValidationResult;
}
...
export interface MetaTagValidator {
  ...
  validateSocialMediaTags(tags: MetaTag[]): import('./validation').ValidationResult;
  validatePerformanceTags(hints: PerformanceHint[]): import('./validation').ValidationResult;
  validateSecurityTags(headers: SecurityHeader[]): import('./validation').ValidationResult;
  validateStructuredData(data: StructuredData[]): import('./validation').ValidationResult;
