...
class StoryValidator {
  ...
  async runValidation() {
    ...
    this.validateFileExists(
      "src/components/content/ArticleCard.astro",
      "2.8-UNIT-001: ArticleCard component exists",
    );
    ...
    this.validateFileContent(
      ...
      [
        ...
        'validTools = ["anki", "migaku", "yomitan"]',
      ],
...
`;
    ...
    if (overall.failed === 0) {
      this.log(
        "🎉 ALL VALIDATIONS PASSED! Story 2.8 is 100% complete.",
        "success",
      );
      process.exit(0);
    } else {
      this.log(
        `⚠️ ${overall.failed} validations failed. Please review issues above.`,
        "error",
      );
      process.exit(1);
    }
