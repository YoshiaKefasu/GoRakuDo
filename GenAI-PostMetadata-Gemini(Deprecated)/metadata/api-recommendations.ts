...
Format your response as JSON with exactly 3 recommendations:
{
  ...
  try {
    const result = await genAI.models.generateContent({
      ...
      config: {
        thinkingConfig: {
          thinkingBudget: 0, // Disables thinking for faster similar content recommendations
        },
      },
    });
...
Format your response as JSON with exactly 3 recommendations:
{
  ...
  try {
    const result = await genAI.models.generateContent({
      ...
      config: {
        thinkingConfig: {
          thinkingBudget: 0, // Disables thinking for faster contextual relevance recommendations
        },
      },
    });
