...
export namespace SEOSafety {
  export type ChangeRestrictionZone =
    import('./safety-system').ChangeRestrictionZone;
  ...
  export type TypeMigrationUtility =
    import('./safety-system').TypeMigrationUtility;
...
export namespace SEOComponents {
  ...
  export type IntegratedSEOProps =
    import('./component-props').IntegratedSEOProps;
  ...
  export type AdvancedMetaConfig =
    import('./component-props').AdvancedMetaConfig;
...
export namespace SEOValidation {
  ...
  export type ValidationSuggestion =
    import('./validation').ValidationSuggestion;
  export type KeywordValidationResult =
    import('./validation').KeywordValidationResult;
  export type KeywordLengthStats = import('./validation').KeywordLengthStats;
  export type KeywordValidationRules =
    import('./validation').KeywordValidationRules;
  export type LanguageSupport = import('./validation').LanguageSupport;
  export type LanguageSpecificRules =
    import('./validation').LanguageSpecificRules;
  export type MetadataValidationResult =
    import('./validation').MetadataValidationResult;
  export type SocialMediaValidation =
    import('./validation').SocialMediaValidation;
  export type TagValidationResult = import('./validation').TagValidationResult;
  export type PerformanceValidation =
    import('./validation').PerformanceValidation;
  export type ResourceHintValidation =
    import('./validation').ResourceHintValidation;
  ...
  export type ReferrerPolicyValidation =
    import('./validation').ReferrerPolicyValidation;
...
export namespace SEOMetadata {
  ...
  export type SocialMediaMetaConfig =
    import('./metadata').SocialMediaMetaConfig;
...
export namespace SEOUtils {
  ...
  export type RequiredProps<
    T,
    K extends keyof T,
  > = import('./utils').RequiredProps<T, K>;
  export type PickProperties<
    T,
    K extends keyof T,
  > = import('./utils').PickProperties<T, K>;
  export type ExcludeProperties<
    T,
    K extends keyof T,
  > = import('./utils').ExcludeProperties<T, K>;
  export type Merge<T extends Record<string, any>[]> =
    import('./utils').Merge<T>;
  ...
  export type And<A extends boolean, B extends boolean> = import('./utils').And<
    A,
    B
  >;
  export type Or<A extends boolean, B extends boolean> = import('./utils').Or<
    A,
    B
  >;
  export type Xor<A extends boolean, B extends boolean> = import('./utils').Xor<
    A,
    B
  >;
  ...
  export type StringPrefix<
    P extends string,
    T extends string,
  > = import('./utils').StringPrefix<P, T>;
  export type StringSuffix<
    T extends string,
    S extends string,
  > = import('./utils').StringSuffix<T, S>;
  export type StringTemplate<
    T extends string,
    U extends Record<string, any>,
  > = import('./utils').StringTemplate<T, U>;

  // Number utility types
  export type NumberRange<
    Start extends number,
    End extends number,
  > = import('./utils').NumberRange<Start, End>;
  export type Add<A extends number, B extends number> = import('./utils').Add<
    A,
    B
  >;
  export type Subtract<
    A extends number,
    B extends number,
  > = import('./utils').Subtract<A, B>;
  export type Multiply<
    A extends number,
    B extends number,
  > = import('./utils').Multiply<A, B>;
  export type Divide<
    A extends number,
    B extends number,
  > = import('./utils').Divide<A, B>;

  // Array utility types
  export type ArrayLength<T extends readonly any[]> =
    import('./utils').ArrayLength<T>;
  export type ArrayFirst<T extends readonly any[]> =
    import('./utils').ArrayFirst<T>;
  export type ArrayLast<T extends readonly any[]> =
    import('./utils').ArrayLast<T>;
  export type ArrayRest<T extends readonly any[]> =
    import('./utils').ArrayRest<T>;
  export type ArrayPush<
    T extends readonly any[],
    U,
  > = import('./utils').ArrayPush<T, U>;
  export type ArrayPop<T extends readonly any[]> =
    import('./utils').ArrayPop<T>;
  export type ArrayShift<T extends readonly any[]> =
    import('./utils').ArrayShift<T>;
  export type ArrayUnshift<
    T extends readonly any[],
    U,
  > = import('./utils').ArrayUnshift<T, U>;
  export type ArrayConcat<
    T extends readonly any[],
    U extends readonly any[],
  > = import('./utils').ArrayConcat<T, U>;
  export type ArraySlice<
    T extends readonly any[],
    Start extends number,
    End extends number,
  > = import('./utils').ArraySlice<T, Start, End>;
  ...
  export type ObjectFromEntries<T extends readonly [PropertyKey, any][]> =
    import('./utils').ObjectFromEntries<T>;
  export type ObjectPick<T, K extends keyof T> = import('./utils').ObjectPick<
    T,
    K
  >;
  export type ObjectOmit<T, K extends keyof T> = import('./utils').ObjectOmit<
    T,
    K
  >;
  ...
  export type FunctionCompose<T extends readonly ((...args: any[]) => any)[]> =
    import('./utils').FunctionCompose<T>;
  ...
  // Error handling utility types
  export type ErrorType<T extends Error = Error> =
    import('./utils').ErrorType<T>;
  export type ErrorResult<
    T,
    E extends Error = Error,
  > = import('./utils').ErrorResult<T, E>;
  export type ErrorHandler<T extends Error = Error> =
    import('./utils').ErrorHandler<T>;
  export type ErrorMapper<
    T extends Error = Error,
    U extends Error = Error,
  > = import('./utils').ErrorMapper<T, U>;
  ...
  export type PerformanceObserver<T extends PerformanceEntry> =
    import('./utils').PerformanceObserver<T>;
